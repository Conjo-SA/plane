  ...
  return (
    <ModalCore isOpen={isOpen} handleClose={onClose} position={EModalPosition.CENTER} width={EModalWidth.VIXL}>
      <div className="flex max-h-[85vh] flex-col">
        ...
        <div
          className="flex min-h-0 flex-1 items-center justify-center overflow-auto bg-layer-1 p-4"
        ...
        >
          ...
          {kind === "pdf" && (
            <iframe src={previewUrl} title={fileName} sandbox="allow-scripts" className="h-[70vh] w-full border-0" />
          )}
        </div>
      </div>
    </ModalCore>
